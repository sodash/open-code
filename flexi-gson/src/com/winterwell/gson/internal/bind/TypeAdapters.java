...
import com.winterwell.gson.JsonNull;
...
import com.winterwell.gson.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
	...
	/**
	 * WTF?! Vanilla gson blocks serialising Class objects?!
	 * Sod that.
	 */
	...
	public static final TypeAdapter<Class> CLASS = new TypeAdapter<Class>() {
		...
		public void write(JsonWriter out, Class value) throws IOException {
			...
			String canon = value.getCanonicalName();
			out.value(canon);
			if (canon==null) {
				throw new UnsupportedOperationException(				
					"Cannot serialize local/anonymous java.lang.Class: "+ value);
			}			
		}
	...
	public static final TypeAdapterFactory CLASS_FACTORY = newFactory(
			Class.class, CLASS);
	...
	public static final TypeAdapterFactory BIT_SET_FACTORY = newFactory(
	...
	public static final TypeAdapterFactory BOOLEAN_FACTORY = newFactory(
	...
	public static final TypeAdapterFactory BYTE_FACTORY = newFactory(
	...
	public static final TypeAdapterFactory NUMBER_FACTORY = newFactory(
			Number.class, NUMBER);
	...
	public static final TypeAdapter<Character> CHARACTER = new TypeAdapter<Character>() {
		...
		public Character read(JsonReader in) throws IOException {
			...
			if (str.length() != 1) {
				throw new JsonSyntaxException("Expecting character, got: "
						+ str);
			}
			return str.charAt(0);
		}
	...
	public static final TypeAdapterFactory CHARACTER_FACTORY = newFactory(
	...
	public static final TypeAdapterFactory INET_ADDRESS_FACTORY = newTypeHierarchyFactory(
	...
	public static final TypeAdapterFactory UUID_FACTORY = newFactory(
			UUID.class, UUID);
	...
	public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
			...
			final TypeAdapter<Date> dateTypeAdapter = gson
	...
	public static final TypeAdapterFactory CALENDAR_FACTORY = newFactoryForMultipleTypes(
	...
	public static final TypeAdapterFactory LOCALE_FACTORY = newFactory(
			Locale.class, LOCALE);
	...
	public static final TypeAdapterFactory JSON_ELEMENT_FACTORY = newTypeHierarchyFactory(
			JsonElement.class, JSON_ELEMENT);
	...
	public static <TT> TypeAdapterFactory newFactory(final TypeToken<TT> type,
	...
	public static <TT> TypeAdapterFactory newFactory(final Class<TT> type,
		...
		return new TypeAdapterFactory() {
			...
			public String toString() {
				return "Factory[type=" + type.getName() + ",adapter="
						+ typeAdapter + "]";
			}
		};
	}
	...
	public static <TT> TypeAdapterFactory newFactory(final Class<TT> unboxed,
			final Class<TT> boxed, final TypeAdapter<? super TT> typeAdapter) {
		return new TypeAdapterFactory() {
			@SuppressWarnings("unchecked")
			// we use a runtime check to make sure the 'T's equal
			public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
	...
	public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(
		...
		return new TypeAdapterFactory() {
			...
			public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
				Class<? super T> rawType = typeToken.getRawType();
				return (rawType == base || rawType == sub) ? (TypeAdapter<T>) typeAdapter
						: null;
			}
	...
	public static <TT> TypeAdapterFactory newTypeHierarchyFactory(
		...
		return new TypeAdapterFactory() {
			@SuppressWarnings("unchecked")
			public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
				return clazz.isAssignableFrom(typeToken.getRawType()) ? (TypeAdapter<T>) typeAdapter
						: null;
			}
